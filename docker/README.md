...
```
0xC17935c619C3Dc7F695BE075BDB0b487F4368FD3

sed -i -e \
    's/0xC17935c619C3Dc7F695BE075BDB0b487F4368FD3/0xe3c35870A2704070C95b8f6EB400540c86B7A312/g' \
    subgraph.yaml

    echo 'REACT_APP_GRAPHQL_ENDPOINT=http://localhost:8000/subgraphs/name/Yoio/testGraph' > .env


cargo run -p graph-node --release -- \
  --postgres-url postgresql://graph-node:let-me-in@localhost:5432/graph-node \
  --ethereum-rpc mainnet:http://18.167.133.255:26659 \
  --ipfs 127.0.0.1:5001
  --node-id william
